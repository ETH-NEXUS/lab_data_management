...
export const createInventoryStockTableColumns = (
  ...
  const columns: ColumnDef<TableRow, unknown>[] = [
    ...
    // Batch 3: remaining material identity fields from the stock detail drawer
    // ("Material identity" and "Metadata" sections).
    {
      id: 'description',
      accessorFn: (row) => getInventoryStockTableSortValue(getStock(row), 'description', t),
      header: t('inventory.stock_table.columns.description'),
      enableSorting: true,
      enableColumnFilter: true,
      size: 220,
      meta: identityMeta,
    ...
    {
      id: 'serialNumber',
      accessorFn: (row) => getInventoryStockTableSortValue(getStock(row), 'serialNumber', t),
      header: t('inventory.stock_table.columns.serial_number'),
      enableSorting: true,
      enableColumnFilter: true,
      size: 150,
      meta: identityMeta,
    ...
    {
      id: 'orderNumber',
      accessorFn: (row) => getInventoryStockTableSortValue(getStock(row), 'orderNumber', t),
      header: t('inventory.stock_table.columns.order_number'),
      enableSorting: true,
      enableColumnFilter: true,
      size: 150,
      meta: identityMeta,
    ...
    {
      id: 'lifetimeDays',
      accessorFn: (row) => getInventoryStockTableSortValue(getStock(row), 'lifetimeDays', t),
      header: t('inventory.stock_table.columns.lifetime_days'),
      enableSorting: true,
      enableColumnFilter: true,
      size: 140,
      meta: identityMeta,

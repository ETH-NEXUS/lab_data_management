    ...
    def sdf(
        ...
        if isfile(sdf_file):
            ...
            for mapping_barcode_idx, mapping_barcode in enumerate(mapping.barcodes):
                ...
                with tqdm(desc='Processing plates', unit='plates', total=len(sdf[mapping_barcode].unique())) as pbar:
                ...
                with tqdm(desc='Processing wells', unit='wells', total=len(sdf.index)) as wbar:
